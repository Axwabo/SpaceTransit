...
Starting from 1.1.0, announcements are generated by my speech synthesis
program [K.A.T.I.E.](https://github.com/Axwabo/K.A.T.I.E./), which
allows me to edit announcement strings more easily instead of
having to specify the audio clips in the correct order per announcement.

# TODO

- [X] ROSS ship remodeling (to double-decker)
- [X] More realistic ROSS audio
- [X] Map view
